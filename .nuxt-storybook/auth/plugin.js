...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/user/login","method":"POST","propertyName":"token"},"logout":{"url":"/logout","method":"POST"},"user":{"url":"/users","method":"get","propertyName":"user"}},"token":{"required":false},"_name":"local"}))
